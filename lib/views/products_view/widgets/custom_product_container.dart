...
class _SmartPhoneContainerState extends State<SmartPhoneContainer> {
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                  ...
                                  onPressed: () {
                                    showingModalBottomSheet(context);
                                  }),
                            ],
                          ),
                        ],
  ...
  Future<dynamic> showingModalBottomSheet(BuildContext context) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SfRangeSlider(
                      min: 0.0,
                      max: 100.0,
                      activeColor: const Color(0xffffae17),
                      values: _values,
                      interval: 20,
                      //showTicks: true,
                      //showLabels: true,
                    ...
                    RadioListTile(
                      ...
                      activeColor: Colors.amber,
                      value: "Nike",
                      groupValue: brandGroupValue,
                      onChanged: (value) {
                        setState(() {
                          brandGroupValue = value.toString();
                        });
                      },
                    ),
                    RadioListTile(
